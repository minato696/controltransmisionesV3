// src/components/transmisiones/FlexibleEstadoIndicador.tsx
...
interface FlexibleEstadoIndicadorProps {
  estado: string;
  reporte: Reporte | null;
  onClick: () => void;
}

const FlexibleEstadoIndicador: React.FC<FlexibleEstadoIndicadorProps> = ({ 
  estado, 
  reporte, 
  onClick 
}) => {
  ...
  return (
    <div className="tooltip-container">
      ...
      {/* Tooltip flexible */}
      <FlexibleTooltip estado={estadoNormalizado} reporte={reporte} />
    </div>
  );
};

export default FlexibleEstadoIndicador;